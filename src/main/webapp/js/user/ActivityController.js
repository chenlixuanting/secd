...
var tp = getTimeSpan();
//加载js 
var loadJS = function (url,useTP) {
    var script = document.createElement('script'); script.type = 'text/javascript'; script.async = true;
	if(useTP == undefined || useTP == true)
	{script.src = url + tp}
	else
	{script.src = url};
    ...
    (function () {
        ...
        !function () {
            window.replace = function () { return "" }; (function () {
                var h = document, c = function (a) { return h.getElementById(a) }, k = null, l = null, m = 0, d= function(){var ele=document.getElementById("cui_nav_ul").getElementsByClassName("cui_subnav_wrap");var rst=new Array();for(var index=0;index<ele.length;index++){rst.push(ele[index].parentNode)}return rst}(), g = {
...
var loadMarketJs = function () {
    try {
        if (marketJS != 'false') {
            ...
            loadJS(protocolpefix + "webresource.c-ctrip.com/ResUnionOnline/R1/remarketing/js/remarketing.js",false);
        }
    }
    catch (e) { };
}
        ...
        if (config.Lang.toLowerCase() == 'big5') {
            ...
            if (data == null) {
                ...
                if (data.hascookieuser == "F") {
                    ...
                    strhtml += "<li class=\"logout\"><a rel=\"nofollow\" id=\"c_ph_logout\" href=\"" + config.H1 + "://" + config.PassportUrl + "/user/logout\" class=\"cui_links_exit\">退出</a></li>";
                    strhtml += "</ul>";
                    pstrshow += "<a rel=\"nofollow\" id=\"c_ph_myhome\" href=\"http://" + config.H3 + "/home/myinfo.aspx#ctm_ref=ssc_hp_myctrip_a\" class=\"cui_myctrip_status\">" + vconfig.v14 + "<b class=\"arrow\"></b></a>";
