...
<head>
    ...
    <style type="text/css">
        ...
        .content, .errorinfo, #footer {
            width: 800px;
        }

        .logo, .tower, .cruise {
            background: url(//pic.c-ctrip.com/common/un_pic.png) no-repeat;
        }

        .wrap {
            background: #1158e7 url(//pic.c-ctrip.com/common/404_bg.jpg) no-repeat center bottom;
            width: 100%;
            overflow: hidden;
        }
        ...
        .beam {
            ...
            width: 973px;
            height: 198px;
            background: url(//pic.c-ctrip.com/common/beam.png) no-repeat;
        ...
        .wave1 {
            ...
            margin-top: -220px;
            color: #999;
            background: url(//pic.c-ctrip.com/common/bl.png) repeat-x 0 0;
        ...
        .wave {
            height: 220px;
            background: url(//pic.c-ctrip.com/common/bl.png) repeat-x 330px 0;
