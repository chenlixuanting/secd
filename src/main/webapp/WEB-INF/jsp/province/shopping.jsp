...
<div id="bdshare_s" style="display: block;">
    <div id="bdshare_m" style="display: none;">
        <div id="bdshare_m_c"><h6>分享到</h6>
            <ul>
                <li><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="bds_mshare mshare">一键分享</a></li>
                <li><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="bds_qzone qqkj">QQ空间</a></li>
                <li><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="bds_tsina xlwb">新浪微博</a></li>
                <li><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="bds_bdysc bdysc">百度云收藏</a></li>
                <li><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="bds_renren rrw">人人网</a></li>
                <li><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="bds_tqq txwb">腾讯微博</a></li>
                <li><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="bds_bdxc bdxc">百度相册</a></li>
                <li><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="bds_more">更多...</a></li>
            </ul>
            <p><a href="http://you.ctrip.com/shopping/guangxi100052.html#" class="goWebsite">百度分享</a></p></div>
    </div>
</div>
<div>
    <div><input type="hidden" id="CorrelationId" name="CorrelationId" value="5885639379239718620">
...
<input type="hidden" id="page_id" value="290551">
...
<div class="ttd2_background">
    <div class="content cf">
        <div class="des_narrow f_left">
            ...
            <input type="hidden" id="putChannelName" value="SHP">
            <input type="hidden" id="putPOIId" value="0">
            <!--侧边特价机票-->
            ...
            <input type="hidden" id="ctmInfo" name="ctmInfo" value="#ctm_ref=gs_SHP_{0}_02_fld_7_100052_undefined">
            <!--侧边热销门票排行-->
